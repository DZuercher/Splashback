...
void cosmology::initialize()
{
    ...
    /// Assign the Gauleg arrays
    x9_16 = new double[N9_16];
    w9_16 = new double[N9_16];
    x0_2p = new double[N0_2p];
    w0_2p = new double[N0_2p];
...
void cosmology::init_Chi(){
    if(!bool_init_Chi){
        ...
        double *xx, *yy;
        xx = new double[10*Nsigma];
        yy = new double[10*Nsigma];
