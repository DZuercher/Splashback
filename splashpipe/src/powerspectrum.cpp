...
void cosmology::init_varM_TH_spline()
{
    ...
    double *xx, *yy;
    xx = new double[Nsigma];
    yy = new double[Nsigma];
...
void cosmology::init_powerspectra_L()
{
    ...
    double *xx, *yy;
    xx = new double[Npower];
    yy = new double[Npower];
...
void cosmology::init_xiNL_bar(double z)
{
    ...
    double *xx, *yy;
    xx = new double[Nxibar];
    yy = new double[Nxibar];
