...
apparent magnitude of the galaxy, recorded by Pan-STARRS. Aassume that the populations of
...
by the expected photmometric errors at that magnitude as reported in Figure~\ref{fig:mag_errors}.
...
Nevertheless we estimate if a $\sim 10$ \% contamination could
