...
$^{2}$Institute for Particle Physics and Astrophysics, Department of Physics, ETH Zurich, Wolfgang Pauli Strasse 27, 8093 Zurich, Switzerland\\
$^{3}$The Inter-University Centre for Astronomy and Astrophysics, Post Bag 4, Ganeshkhind, Pune 411007, India\\
$^{4}$ dominik.zuercher@phys.ethz.ch
}
...
500c}=3.0\times10^{14}\msunh$ at an average redshift of $z=0.18$. {\bf The inferred
...
To avoid such optical cluster selection effects, there have been some
...
ratio remains a significant hurdle for both of them. The use of weak
...
In this work, we explore clusters selected using the SZ effect. While
...
Dynamical friction is expected to slow down massive subhalos, hosting
...
$r$ and projected distances by $R$. {\bf All distance measurements in this 
...
We let the parameters $\rho_{\mathrm{s}}$, $\rho_0$ and
...
It has been a common concern that the profile in
...
The location of the splashback radius can be identified in various
...
in all three measurements. The signal-to-noise ratios of the
...
We show the two-dimensional posterior distributions for each pair of
...
\begin{figure*}
	\centering{
    \includegraphics[trim = 0mm 2mm 0mm 0mm, clip, scale=0.8]{MAIN_results_with_spline_no_mc_1.pdf}
    \includegraphics[trim = 0mm 2mm 0mm 0mm, clip, scale=0.8]{MAIN_results_with_spline_no_mc_2.pdf}
}
...
\begin{figure}
	\centering{
    \includegraphics[trim = 0mm 2mm 0mm 0mm, clip,scale=0.75]{MAIN_color_results_with_spline_no_mc_1.pdf}
...
is $M_{\rm 500c}=3.0\times10^{14}$ $\msunh$. {\bf We convert this mass
...
presented in \citet{more2015splashback}. {\bf The splashback radius we
...
At face value, this result seems to be at odds with the findings
...
\item {\bf The location of the inferred splashback radius is $r_{\rm
...
{\bf While this work was in preparation, we became aware of a related study
...
{\bf Based on observations obtained with Planck
