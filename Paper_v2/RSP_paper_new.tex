...
parameters $\log_{10}(\beta)$ and $\log_{10}(\gamma)$ we also use normal priors
with central values $\log_{10}(6.0)$ and $\log_{10}(4.0)$, respectively and
scale 0.4 as recommended by \citet{diemer2014dependence}.}
...
Equation~\ref{eq:model} for the PS 21.5 sample. We show the 68\% and 95\%
confidence regions.
}
